...
def test_parse():
    ...
    EXPECTED = {
        ...
        StatusRegister.TERMINAL_COVER_OFF: 0,
        StatusRegister.OVERVOLTAGE: 0,
        StatusRegister.POWER_OVER_REF: 0,
        StatusRegister.IS_PRODUCER: 1,
        StatusRegister.IS_INJECTING: 0,
        ...
        StatusRegister.STATUS_CPL: cpl_status[1],
